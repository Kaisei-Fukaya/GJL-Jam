...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        PlayerAnimationController.Instance.SetAnimatorParameter("grounded", _isGrounded);
        ...
        PlayerAnimationController.Instance.SetAnimatorParameter("momentum", _momentumMultiplier);       //Set animation parameters
    ...
    {
        _isSliding = false;
        PlayerAnimationController.Instance.SetAnimatorParameter("slide", false);
        _targetScale = 1f;
    }
